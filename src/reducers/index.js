...
/* 
    ...
    [ rule of reducers ]
    // 1) A reducer must return a value. Undefined will generate an error.
    ...
    // 2) Each reducer has two arguments : state and action value(object) through dispatch.
        ...
        However, the reducer does allow any “undefined” value return to combineReducers 
        ...
        It must a value defined in the first call. 
    ...
    //  In other wrods, the reducer never gets:
        ...
        only state and action can be manipulated in the reducers!

    //4) Never mutate "state" value of array and object.. =========== But it not true.
    // It is only for beginner to easily understand the reducers!
    // No mutation of state is a convention or recommendation, by the way.
    // visit at github.com/reduxjs/redux
    // The reson is because previous state is stored redux and the next state value can accidently sames as previous value.
    // like the one below. ***************************************************************8
